...
export default function AdminResumenPage() {
  ...
  return (
    <div className="p-8">
      ...
      <Reveal delay={200}>
        <div className="mt-10">
          <h2 className="font-subtitle text-xl font-bold text-ink-900">
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="mt-1 font-subtitle text-lg font-bold text-ink-900">
                      {f.nombre}
                    </p>
                  </div>
...
function StatCard({
  ...
  return (
    <div className="group bg-paper-50 p-6 transition-colors hover:bg-paper-100/60">
      ...
      <p className="mt-1 font-subtitle text-2xl font-bold tabular-nums text-ink-900">
        {value}
      </p>
    </div>
  );
...
function ChartCard({
  ...
  return (
    <div className="h-full rounded-[2px] border border-paper-line bg-paper-50 p-6 transition-shadow hover:shadow-[0_16px_30px_-20px_rgba(12,23,18,0.35)]">
      <h3 className="font-subtitle text-lg font-bold text-ink-900">
        {title}
      </h3>
